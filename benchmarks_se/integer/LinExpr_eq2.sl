...
( constraint (  iteB  (>=  ( five-times z) ( three-times 5 ) ) 
		      ( iteB  (  <=  ( seven-times x ) ( nine-times y ) ) 
		  	      (  =  ( eq2 x y z ) ( plus3  ( three-times x)  ( minus ( five-times y )) z ) )
			      (  =  ( eq2 x y z ) ( plus4 x x  (minus z) 5 ) ) )
  		      ( iteB  (  <=  ( three-times z ) ( plus3 (minus y) x x ) ) 
