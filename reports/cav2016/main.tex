...
\begin{theorem}
  ...
  Further, assuming an angelic {\tt LearnDT} procedure, if there exists
  a solution expression, Algorithm~\ref{algo:main} is guaranteed to find
  it.
\end{theorem}
\arsays{Explain what the angelic learnDT algorithm is}
