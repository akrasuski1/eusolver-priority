...
the \textsc{enumerate} procedure\footnote{Note that {\tt Enumerate} is
a coprocedure.  Unfamiliar readers may assume that each call to {\tt
...
Appendix~\ref{section:appendix_esolver}.
