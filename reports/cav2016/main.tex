...
technology}}
Program synthesis is an increasingly popular technique \dots
The aim is to allow
Recent research into inductive program synthesis

Syntax-guided synthesis (\sygus) is a recent paradigm in program
synthesis proposed as an enabling technology \dots
In the \sygus approach, there are restrictions on both the form (syntax)
and function (semantics) of the program to be synthesized:
\begin{inparaenum}[(a)]
...
\marginnote{Para 2 {\sygus approaches and enumerative solver +
limitations}}
...
\marginnote{Para 4 {Details of techniques, decision trees}}
For combining the different part of the solution, we use the technique
of learning decision trees~\cite{ID3,etc,probably_mitchell_book}.
