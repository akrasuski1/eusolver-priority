...
\arsays{complete this}
\arsays{algorithm is incomplete without adding terms}
Note that by the properties of the decision tree learning algorithm, and
we have that $\DTtoExpr{\DecisionTree}$ is correct on every $\Point \in
\Points$.
