...
\centering
  \begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      \addplot[color=red,fill=red] table[x=solver,y=EUSolver]{\solvedData};
      \addplot[color=blue,fill=blue] table[x=solver,y=CVC4]{\solvedData};
      \addplot[color=green,fill=green] table[x=solver,y=ESolver]{\solvedData};
    \end{axis}
  \end{tikzpicture}
