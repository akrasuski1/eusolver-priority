...
\comment{
We were able to obtain upto $???\%$ reduction in solution size in some
cases.
 The tool was able
...
\begin{subfigure}{0.33\textwidth}
  \begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      \addplot[mark=.,color=black!60!green] table {plots/general_esolver.dat};
    \end{axis}
    %\end{semilogyaxis}
  \end{tikzpicture}
...
\centering
  ...
  $y$-coordinate.
  \caption{Running times for \esolver (green), CVC4 (blue), and \eusolver (red)}
  \label{fig:results}
\end{figure}
...
has also been studied extensively~\cite{kuncak-10,kneuss-13,albarghouthi-13,feser-15}.
